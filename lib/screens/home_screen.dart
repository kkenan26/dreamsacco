...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _loadUser() async {
    ...
    if (user != null && mounted) {
      setState(() {
        userName = user.name;
        memberId = user.uid.substring(0, 6).toUpperCase();
      });
    }
  }
              ...
              child: Column(
                children: [
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            ...
                            Text(hideBalance ? "******" : savingsAmount,
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 18))
                  ...
                  Chip(
                    ...
                    label: Text("Contributions: $contributionStatus",
                        style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          CircleAvatar(
                            backgroundColor:
                            (s["color"] as Color).withValues(alpha: .12),
                            child:
